...
const firebaseConfig = {
  ...
  databaseURL: 'https://simulator-smart-default-rtdb.firebaseio.com',
...
export async function writeUserData(
  ...
  try {
    ...
    const postListRef = ref(db, 'usersData');
    ...
    set(newPostRef, {
      ...
      numRepresentante: numRep,
      puntAtencion: puntAt,
      puntRazonamientoL: puntRazL,
      puntRazonamientoV: puntRazV,
      puntRazonamientoN: puntRazN,
      puntTotal: puntTotal,
    });
  } catch (error) {
    console.log(error);
...
export const readData = () => {
  const db = getDatabase();
  const starCountRef = ref(db, 'usersData/');
  var dataU;
